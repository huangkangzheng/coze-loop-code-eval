...
// Source: code.byted.org/flowdevops/cozeloop/backend/modules/observability/domain/component/config (interfaces: ITraceConfig)
//
...
import (
	...
	config "code.byted.org/flowdevops/cozeloop/backend/modules/observability/domain/component/config"
	conf "code.byted.org/flowdevops/cozeloop/backend/pkg/conf"
