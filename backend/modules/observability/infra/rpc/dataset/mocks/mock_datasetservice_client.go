...
// Source: code.byted.org/flowdevops/cozeloop/backend/kitex_gen/coze/loop/data/datasetservice (interfaces: Client)
//
// Generated by this command:
//
//	mockgen -package=mocks -destination=modules/observability/infra/rpc/dataset/mocks/mock_datasetservice_client.go code.byted.org/flowdevops/cozeloop/backend/kitex_gen/coze/loop/data/datasetservice Client
//
