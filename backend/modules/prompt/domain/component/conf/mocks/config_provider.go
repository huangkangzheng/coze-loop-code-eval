...
// Source: code.byted.org/flowdevops/cozeloop/backend/modules/prompt/domain/component/conf (interfaces: IConfigProvider)
//
...
import (
	...
	prompt "code.byted.org/flowdevops/cozeloop/backend/kitex_gen/coze/loop/prompt/domain/prompt"
