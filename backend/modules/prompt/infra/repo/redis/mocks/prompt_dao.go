...
// Source: code.byted.org/flowdevops/cozeloop/backend/modules/prompt/infra/repo/redis (interfaces: IPromptDAO)
//
...
import (
	...
	redis "code.byted.org/flowdevops/cozeloop/backend/modules/prompt/infra/repo/redis"
