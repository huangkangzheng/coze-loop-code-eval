...
import (
	...
	domain "code.byted.org/flowdevops/cozeloop/backend/kitex_gen/coze/loop/foundation/domain/user"
	...
	servicemocks "code.byted.org/flowdevops/cozeloop/backend/modules/foundation/domain/user/service/mocks"
