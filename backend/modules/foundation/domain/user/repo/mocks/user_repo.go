...
// Source: code.byted.org/flowdevops/cozeloop/backend/modules/foundation/domain/user/repo (interfaces: IUserRepo)
//
...
import (
	...
	repo "code.byted.org/flowdevops/cozeloop/backend/modules/foundation/domain/user/repo"
