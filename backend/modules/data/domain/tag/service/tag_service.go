...
type ITagService interface {
	...
	UpdateOptionTag(ctx context.Context, spaceID, tagKeyID int64, val *entity2.TagKey, opts ...db.Option) error
	// ArchiveOptionTag 将单选转为标签
	ArchiveOptionTag(ctx context.Context, spaceID, tagKeyID int64, val *entity2.TagKey, opts ...db.Option) error
	/* For handler */
