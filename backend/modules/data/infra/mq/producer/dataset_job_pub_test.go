...
import (
	...
	infra_mq "code.byted.org/flowdevops/cozeloop/backend/infra/mq"
	mock_infra_mq "code.byted.org/flowdevops/cozeloop/backend/infra/mq/mocks" // 使用这个路径
	"code.byted.org/flowdevops/cozeloop/backend/modules/data/domain/component/conf"
	mock_config "code.byted.org/flowdevops/cozeloop/backend/modules/data/domain/component/conf/mocks"
	component_mq "code.byted.org/flowdevops/cozeloop/backend/modules/data/domain/dataset/component/mq"
