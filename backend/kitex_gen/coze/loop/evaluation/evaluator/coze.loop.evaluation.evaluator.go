...
func (p *GetTemplateInfoRequest) GetBase() (v *base.Base) {
	...
	if !p.IsSetBase() {
		return GetTemplateInfoRequest_Base_D
...
var fieldIDToName_GetTemplateInfoRequest
}
...
func (p *GetTemplateInfoRequest) DeepEqual(ano *GetTemplateInfoRequest) bool {
	...
	if !p.Field255DeepEqual(ano.Base) {
		return false
*GetTemplateInfoRequest) Field2DeepEqual(src string) bool {
...
Request) (r *GetEvaluatorRecordResponse, err error)
...
func (p *EvaluatorServiceProcessor) P
...
", &evaluatorServiceProcessorValidateEvaluator{handler: handler})
...
WriteFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T write field 0 begin error: ", p), err)
WriteFieldEndError:
	return thrift.PrependError(fmt.Sprintf("%T write field 0 en
		_, fieldTypeId, fieldId, err = iprot.ReadFieldBegin()
		if err != nil {
			goto ReadFieldBeginError
		}
