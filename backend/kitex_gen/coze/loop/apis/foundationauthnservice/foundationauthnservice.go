...
var (
	foundationAuthNServiceServiceInfo = NewServiceInfo()
)

// for server
func serviceInfo() *kitex.ServiceInfo {
	return foundationAuthNServiceServiceInfo
}
...
func newServiceInfo() *kitex.ServiceInfo {
	serviceName := "FoundationAuthNService"
	handlerType := (*apis.FoundationAuthNService)(nil)
