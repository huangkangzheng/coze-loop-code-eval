...
type ListPreSpanRequest struct {
	...
	SpanID             *string              `thrift:"span_id,3,optional" frugal:"3,optional,string" form:"span_id" json:"span_id,omitempty"`
	PreviousResponseID *string              `thrift:"previous_response_id,4,optional" frugal:"4,optional,string" form:"previous_response_id" json:"previous_response_id,omitempty"`
...
func (p *ListPreSpanRequest) writeField4(oprot thrift.TProtocol) (err error) {
	if p.IsSetPreviousResponseID() {
		if err = oprot.WriteFieldBegin("previous_response_id", thrift.STRING, 4); err != nil {
			goto WriteFieldBeginError
		}
...
func (p *ListPreSpanRequest) DeepEqual(ano *ListPreSpanRequest) bool {
	...
	if !p.Field4DeepEqual(ano.PreviousResponseID) {
		return false
	}
...
func (p *ListPreSpanRequest) Field3DeepEqual(src *string) bool {
...
func (p *ListPreSpanRequest) Field5DeepEqual(src *common.PlatformType) bool {
