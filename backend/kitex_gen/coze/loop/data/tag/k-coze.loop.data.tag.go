...
func (p *CreateTagRequest) FastReadField9(buf []byte) (int, error) {
	offset := 0
...
func (p *CreateTagRequest) fastWriteField9(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
	if p.IsSetTagType() {
...
func (p *CreateTagRequest) field9Length() int {
	l := 0
	if p.IsSetTagType() {
		l += thrift.Binary.FieldBeginLength()
...
func (p *ArchiveOptionTagRequest) FastRead(buf []byte) (int, error) {
...
ReadFieldBeginError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_ArchiveOptionTagRequest[fieldId]), err)
SkipFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
RequiredFieldNotSetError:
	return offset, thrift.NewProtocolException(thrift.INVALID_DATA, fmt.Sprintf("required field %s is not set", fieldIDToName_ArchiveOptionTagRequest[fieldId]))
}

func (p *ArchiveOptionTagRequest) FastReadField1(buf []byte) (int, error) {
	offset := 0
...
func (p *ArchiveOptionTagRequest) FastReadField2(buf []byte) (int, error) {
	offset := 0
...
func (p *ArchiveOptionTagRequest) FastReadField3(buf []byte) (int, error) {
	offset := 0
...
func (p *ArchiveOptionTagRequest) FastReadField4(buf []byte) (int, error) {
	offset := 0
...
func (p *ArchiveOptionTagRequest) FastReadField255(buf []byte) (int, error) {
	offset := 0
	_field := base.NewBase()
	if l, err := _field.FastRead(buf[offset:]); err != nil {
		return offset, err
...
func (p *ArchiveOptionTagRequest) FastWrite(buf []byte) int {
	return p.FastWriteNocopy(buf, nil)
}

func (p *ArchiveOptionTagRequest) FastWriteNocopy(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
	if p != nil {
		offset += p.fastWriteField1(buf[offset:], w)
		offset += p.fastWriteField2(buf[offset:], w)
...
func (p *ArchiveOptionTagRequest) BLength() int {
	l := 0
	if p != nil {
		l += p.field1Length()
		l += p.field2Length()
...
func (p *ArchiveOptionTagRequest) fastWriteField1(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
	offset += thrift.Binary.WriteFieldBegin(buf[offset:], thrift.I64, 1)
	offset += thrift.Binary.WriteI64(buf[offset:], p.WorkspaceID)
	return offset
...
func (p *ArchiveOptionTagRequest) fastWriteField2(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
	offset += thrift.Binary.WriteFieldBegin(buf[offset:], thrift.I64, 2)
	offset += thrift.Binary.WriteI64(buf[offset:], p.TagKeyID)
	return offset
...
func (p *ArchiveOptionTagRequest) fastWriteField3(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
	offset += thrift.Binary.WriteFieldBegin(buf[offset:], thrift.STRING, 3)
...
func (p *ArchiveOptionTagRequest) fastWriteField4(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
	if p.IsSetDescription() {
		offset += thrift.Binary.WriteFieldBegin(buf[offset:], thrift.STRING, 4)
		offset += thrift.Binary.WriteStringNocopy(buf[offset:], w, *p.Description)
...
func (p *ArchiveOptionTagRequest) fastWriteField255(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
	if p.IsSetBase() {
		offset += thrift.Binary.WriteFieldBegin(buf[offset:], thrift.STRUCT, 255)
		offset += p.Base.FastWriteNocopy(buf[offset:], w)
...
func (p *ArchiveOptionTagRequest) field1Length() int {
	l := 0
	l += thrift.Binary.FieldBeginLength()
	l += thrift.Binary.I64Length()
	return l
...
func (p *ArchiveOptionTagRequest) field2Length() int {
	l := 0
	l += thrift.Binary.FieldBeginLength()
	l += thrift.Binary.I64Length()
	return l
...
func (p *ArchiveOptionTagRequest) field3Length() int {
	l := 0
	l += thrift.Binary.FieldBeginLength()
...
func (p *ArchiveOptionTagRequest) field4Length() int {
	l := 0
	if p.IsSetDescription() {
		l += thrift.Binary.FieldBeginLength()
		l += thrift.Binary.StringLengthNocopy(*p.Description)
...
func (p *ArchiveOptionTagRequest) field255Length() int {
	l := 0
	if p.IsSetBase() {
		l += thrift.Binary.FieldBeginLength()
		l += p.Base.BLength()
...
func (p *ArchiveOptionTagRequest) DeepCopy(s interface{}) error {
	src, ok := s.(*ArchiveOptionTagRequest)
	if !ok {
		return fmt.Errorf("%T's type not matched %T", s, p)
	}
...
func (p *ArchiveOptionTagResponse) FastRead(buf []byte) (int, error) {
...
ReadFieldBeginError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_ArchiveOptionTagResponse[fieldId]), err)
SkipFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
}

func (p *ArchiveOptionTagResponse) FastReadField255(buf []byte) (int, error) {
	offset := 0
	_field := base.NewBaseResp()
	if l, err := _field.FastRead(buf[offset:]); err != nil {
		return offset, err
...
func (p *ArchiveOptionTagResponse) FastWrite(buf []byte) int {
	return p.FastWriteNocopy(buf, nil)
}

func (p *ArchiveOptionTagResponse) FastWriteNocopy(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
	if p != nil {
		offset += p.fastWriteField255(buf[offset:], w)
	}
...
func (p *ArchiveOptionTagResponse) BLength() int {
	l := 0
	if p != nil {
		l += p.field255Length()
	}
...
func (p *ArchiveOptionTagResponse) fastWriteField255(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
	if p.IsSetBaseResp() {
		offset += thrift.Binary.WriteFieldBegin(buf[offset:], thrift.STRUCT, 255)
		offset += p.BaseResp.FastWriteNocopy(buf[offset:], w)
...
func (p *ArchiveOptionTagResponse) field255Length() int {
	l := 0
	if p.IsSetBaseResp() {
		l += thrift.Binary.FieldBeginLength()
		l += p.BaseResp.BLength()
...
func (p *ArchiveOptionTagResponse) DeepCopy(s interface{}) error {
	src, ok := s.(*ArchiveOptionTagResponse)
	if !ok {
		return fmt.Errorf("%T's type not matched %T", s, p)
	}
...
func (p *TagServiceArchiveOptionTagArgs) FastRead(buf []byte) (int, error) {
...
ReadFieldBeginError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_TagServiceArchiveOptionTagArgs[fieldId]), err)
SkipFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
}

func (p *TagServiceArchiveOptionTagArgs) FastReadField1(buf []byte) (int, error) {
	offset := 0
...
func (p *TagServiceArchiveOptionTagArgs) FastWrite(buf []byte) int {
	return p.FastWriteNocopy(buf, nil)
}

func (p *TagServiceArchiveOptionTagArgs) FastWriteNocopy(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
	if p != nil {
		offset += p.fastWriteField1(buf[offset:], w)
	}
...
func (p *TagServiceArchiveOptionTagArgs) BLength() int {
	l := 0
	if p != nil {
		l += p.field1Length()
	}
...
func (p *TagServiceArchiveOptionTagArgs) fastWriteField1(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
	offset += thrift.Binary.WriteFieldBegin(buf[offset:], thrift.STRUCT, 1)
...
func (p *TagServiceArchiveOptionTagArgs) field1Length() int {
	l := 0
	l += thrift.Binary.FieldBeginLength()
	l += p.Request.BLength()
	return l
...
func (p *TagServiceArchiveOptionTagArgs) DeepCopy(s interface{}) error {
	src, ok := s.(*TagServiceArchiveOptionTagArgs)
	if !ok {
		return fmt.Errorf("%T's type not matched %T", s, p)
	}

	var _request *ArchiveOptionTagRequest
	if src.Request != nil {
		_request = &ArchiveOptionTagRequest{}
...
func (p *TagServiceArchiveOptionTagResult) FastRead(buf []byte) (int, error) {
...
ReadFieldBeginError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_TagServiceArchiveOptionTagResult[fieldId]), err)
SkipFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
}

func (p *TagServiceArchiveOptionTagResult) FastReadField0(buf []byte) (int, error) {
	offset := 0
...
func (p *TagServiceArchiveOptionTagResult) FastWrite(buf []byte) int {
	return p.FastWriteNocopy(buf, nil)
}

func (p *TagServiceArchiveOptionTagResult) FastWriteNocopy(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
	if p != nil {
		offset += p.fastWriteField0(buf[offset:], w)
	}
...
func (p *TagServiceArchiveOptionTagResult) BLength() int {
	l := 0
	if p != nil {
		l += p.field0Length()
	}
...
func (p *TagServiceArchiveOptionTagResult) fastWriteField0(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
	if p.IsSetSuccess() {
		offset += thrift.Binary.WriteFieldBegin(buf[offset:], thrift.STRUCT, 0)
		offset += p.Success.FastWriteNocopy(buf[offset:], w)
...
func (p *TagServiceArchiveOptionTagResult) field0Length() int {
	l := 0
	if p.IsSetSuccess() {
		l += thrift.Binary.FieldBeginLength()
		l += p.Success.BLength()
...
func (p *TagServiceArchiveOptionTagResult) DeepCopy(s interface{}) error {
	src, ok := s.(*TagServiceArchiveOptionTagResult)
	if !ok {
		return fmt.Errorf("%T's type not matched %T", s, p)
	}

	var _success *ArchiveOptionTagResponse
	if src.Success != nil {
		_success = &ArchiveOptionTagResponse{}
		if err := _success.DeepCopy(src.Success); err != nil {
			return err
		}
	}
...
func (p *TagServiceArchiveOptionTagArgs) GetFirstArgument() interface{} {
	return p.Request
}

func (p *TagServiceArchiveOptionTagResult) GetResult() interface{} {
	return p.Success
}
