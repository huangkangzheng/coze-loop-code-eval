...
gen_module="code.byted.org/flowdevops/cozeloop/backend"
...
loopgen --gomod ${gen_module} \
  ...
  --local-stream-import-path "code.byted.org/flowdevops/cozeloop/backend/loop_gen/infra/kitex/localstream" \
  -o ${OUTPUT_DIR}
