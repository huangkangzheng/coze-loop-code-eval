...
cloudwego_hz update -enable_extends -handler_dir=handler -model_dir=model -use=code.byted.org/flowdevops/cozeloop/backend/kitex_gen --customize_package=tpl/package.yaml -idl $API_IDL
